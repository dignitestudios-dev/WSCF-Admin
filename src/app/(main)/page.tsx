        ...
        <div className="xl:col-span-6 flex flex-col gap-6 w-full">
          ...
          <div className="h-[476px] bg-[#083F92] rounded-[32.9px] p-8 flex flex-col justify-between relative overflow-hidden shadow-lg text-white">
            ...
            <div className="flex flex-col items-center justify-center relative w-full h-[244px] z-10 mt-4">
              <svg width="300" height="150" viewBox="0 0 200 100" className="w-[300px] h-[150px]">
                {/* Background arc */}
                <path 
                ...
                {/* Active progress arc */}
                <path 
                  d="M 20 90 A 80 80 0 0 1 140 30" 
                  fill="none" 
                  stroke="#FFFFFF" 
                  strokeWidth="20" 
                  strokeLinecap="round" 
              ...
              <div className="absolute bottom-4 flex flex-col items-center">
                <span className="font-poppins font-semibold text-[52px] leading-[60px] tracking-[-0.05em] text-white">
                  124
                </span>
                <span className="font-poppins font-light text-[12px] leading-[16px] tracking-[-0.05em] text-white/80">
            ...
            <div className="flex justify-between items-center w-full max-w-[318px] mx-auto z-10 border-t border-white/10 pt-4">
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 rounded-full bg-[#D7D7D7] shrink-0" />
                <span className="font-poppins font-medium text-[16px] leading-[20px] tracking-[-0.05em] text-white">
                  32 In-Progress
                </span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 rounded-full bg-[#F0F0F0] shrink-0" />
                <span className="font-poppins font-medium text-[16px] leading-[20px] tracking-[-0.05em] text-white">
                  24 Upcoming
                </span>
              </div>
            ...
            {/* Decorative background vectors matching Figma */}
            <div className="absolute right-[-10px] top-[107px] w-[128px] h-[128px] rounded-full bg-white/5 rotate-[-22deg] pointer-events-none select-none" />
            <div className="absolute left-[110px] top-[108px] w-[126px] h-[126px] rounded-full bg-white/5 rotate-[-21deg] pointer-events-none select-none" />
          </div>
