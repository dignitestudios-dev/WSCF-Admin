  ...
  return (
    <div className="w-[421px] flex flex-col items-center gap-[32px]">
      ...
      <div className="flex flex-col justify-center items-center gap-[12px] w-[421px]">
        <h1 className="w-[316px] h-[49px] font-semibold text-[36px] leading-[49px] text-center tracking-[-0.008em] capitalize text-[#083F92] m-0">
          Set New Password
        </h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col items-center gap-[26px] w-full max-w-[421px]">
        ...
        <Button 
          type="submit" 
          disabled={isPending}
          className="w-full max-w-[343px] h-[48px] bg-[#083F92] hover:bg-[#083F92]/90 rounded-[24px] flex justify-center items-center mt-[12px] disabled:opacity-50 shadow-[0px_4px_4px_rgba(61, 55, 117, 0.25)]"
        >
